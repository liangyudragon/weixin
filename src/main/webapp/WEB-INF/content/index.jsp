...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<%=basePath%>/resources/backstage/css/backstage.css" media="all">
</head>
<body>
<div class="layui-layout layui-layout-admin" id="layui_layout">
  <!-- 顶部区域 -->
  <div class="layui-header header-menu">
    <div class="logo posb" id="log"><img src="<%=basePath%>/resources/common/images/logo.png"></div>
    ...
    <div class="layui-tab" id="larry-tab" lay-filter="larryTab">
      ...
      <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
          <iframe class="larry-iframe" data-id='0' name="ifr_0" id='ifr0' src="index/main.do"></iframe>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="layui-footer layui-larry-foot psob" id="larry-footer">
    <div class="layui-main">
      <div class="left-box" style="display:none;">
        LarryCMS QQ群：<a href="https://jq.qq.com/?_wv=1027&amp;k=42fC4vT" target="_blank"><img border="0" src="<%=basePath%>/resources/backstage/images/group.png" title="LarryCMS官方交流群"></a> 加群下载模板源码
...
<div class="lock-screen" style="display: none;">
  <div class="lock-wrapper" id="lock-screen">
    <div id="time"></div>
    <div class="lock-box">
      <img src="<%=basePath%>/resources/backstage/images/user.jpg" alt="">
      <h1>admin</h1>
...
<script type="text/javascript" src="<%=basePath%>/resources/backstage/js/larrycms.js"></script>
</body>
</html>