...
public class JsonMapper {
	 ...
	 * 构造带范型的类型.
	 */
	public JavaType constructParametricType(Class<? extends Map> mapClass, Class<?> keyClass, Class<?> valueClass) {
	...
	public void update(String jsonString, Object object) {
		try {
			...
			//LOGGER.warn("update json string:{} to object:{} error.JsonProcessingException", jsonString, object, e);
		}
		catch (IOException e) {
			//LOGGER.warn("update json string:{} to object:{} error.IOException", jsonString, object, e);
		}
	}
